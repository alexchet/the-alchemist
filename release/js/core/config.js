...
const STRETCH_TO_SCREEN = true;

// user options that can be set from the main menu — replaced wholesale on load from cookie
let OPTIONS = { animation: true, music: true, sfx: true, minimap: true };
